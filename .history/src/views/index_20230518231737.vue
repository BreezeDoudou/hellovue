<template id="app">
  <el-container>
    ...
    <div class="about-us">
      <h3>关于我们</h3>
      <p>我们是一家致力于提供宠物销售、医疗、配种和培训等服务的专业团队。</p>
      <p>如有任何需要帮助您的地方，请联系我们：</p>
      <p><i class="el-icon-phone"></i>&nbsp;&nbsp;电话：021-12345678</p>
      <p><i class="el-icon-message"></i>&nbsp;&nbsp;邮箱：support@petstore.com</p>
    </div>
    ...
    <div class="follow-us">
      <h3>关注我们</h3>
      <p>加入我们的社交圈，与其他爱宠人士分享你的心得体会！</p>
      <div class="social-media-icons">
        <i class="el-icon-s-promotion"></i>
        <i class="el-icon-s-help"></i>
        <i class="el-icon-s-opportunity"></i>
        <i class="el-icon-s-flag"></i>
        <i class="el-icon-s-more"></i>
      </div>
    </div>
  </el-footer>
  </el-container>
